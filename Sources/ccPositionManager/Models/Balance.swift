...
final class Balance
{
    ...
    init(accruedInterest: Double, bondValue: Double, buyingPower: Double, cashBalance: Double, cashAvailableForTrading: Double, mutualFundValue: Double, moneyMarketFund: Double, totalCash: Double, isInCall: Bool, unsettledCash: Double)
    {
