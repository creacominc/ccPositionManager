...
final class Position
{
    ...
    init(averagePrice: Double, currentDayProfitLoss: Double, currentDayProfitLossPercentage: Double, longQuantity: Double, settledLongQuantity: Double, settledShortQuantity: Double, symbol: String, instrumentDescription: String, marketValue: Double)
    {
